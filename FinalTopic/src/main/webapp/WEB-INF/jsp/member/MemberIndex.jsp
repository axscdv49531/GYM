                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="right_top_section">
                                    ...
                                    <!-- button section -->
                                    <ul class="login">
                                        <li class="login-modal"><a href="<c:url value='/login/page' />"
                                                class="login"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                    height="16" fill="currentColor" class="bi bi-lock-fill"
                                                    viewBox="0 0 16 16">
                                                    <path
                                                        d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z" />
                                                </svg><i class="fa fa-user"></i>密碼變更</a></li>
                                        <li class="logout-modal"><a href="<c:url value='/logout' />" class="logout"><svg
                                            ...
                                            <nav class="navbar navbar-inverse">
                                                ...
                                                <div class="collapse navbar-collapse js-navbar-collapse">
                                                    <ul class="nav navbar-nav">
                                                        ...
                                                        <li><a href="<c:url value= '/showCoachList'/>">教練師資</a>
                                                        </li>
                                                        ...
                                                        <li class="dropdown mega-dropdown"><a href="#"
                                                            ...
                                                            <ul class="dropdown-menu mega-dropdown-menu classRes">
                                                                <li class="col-sm-12">
                                                                    <ul>
                                                                        <li class="dropdown-header">Men
                                                                            Collection</li>
                                                                        <li><a class="dropdown-item"
                                                                                href="/courseSelectSystem">課程表</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item"
                                                                                href="/courseSelectSystem">預約課程</a>
                                                                        </li>
                                                                        <li><a class="dropdown-item" href="#">課程介紹</a>
                                                                        </li>
                            ...
                            <div class="carousel-caption">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                    <div class="slider-contant" data-animation="animated fadeInRight">
                                        <h3>
                                            全民健身，男女老少，動起來吧，给自己一個更好的未來。<br> <span class="color-yellow">立即體驗</span><br>
                                        </h3>
                                        <p>

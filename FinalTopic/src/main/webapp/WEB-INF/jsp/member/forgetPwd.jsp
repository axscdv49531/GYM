	...
	<div align="center">
		<form:form method='POST' modelAttribute="memberBean">
			...
			<fieldset class="fieldset-auto-width">
				...
				<table>
					<tr>
						<td align='right'>信箱：<br>&nbsp;
						<td><form:input type="email" path="email" id="email" /><br>&nbsp;
							<form:errors path="email" cssClass="error"></form:errors> <span
					...
					<tr>
						...
						<td><form:input type="phone" path="phone" /><br>&nbsp;
							<form:errors path="phone" cssClass="error" /><span id="phone"
							class="error"></span></td>
					</tr>
					<tr>
						<td colspan='2' align='center'><input class="button"
							type='submit' value='送出' name='updateBtn'>&nbsp;</td>
					</tr>
				</table>
			</fieldset>
		</form:form>
		<a href="<c:url value='/login/Member' />">回前頁</a>
	</div>

                            ...
                            if (data == null) {
                                ...
                                $.each(data,function(i, n) {
                                                    ...
                                                    var div2 = "<div class='col-lg-3 col-sm-6 col-xs-12'><div class='news-post-widget'><img class='img-responsive' src="
                                                        + "<c:url value='/getClassPicture?classId=' />"+ n.classId +" alt=''><div class='news-post-detail'><h2><a href='blog-detail.html'>" + n.className + "</a></h2><p style='color:white;text-align:left'>教練名稱：" + n.cBean.coachName + "</p><p style='color:white;text-align:left'>上課日期：" + n.classDate + "</p><p style='color:white;text-align:left'>上課時間：" + n.classStartTime + "</p><p style='color:white;text-align:left'>課程時長：" + n.classDuration + " 小時</p><p><input type='button' style='float:none' value='查看' class='btn' onclick=" + "location.href='/member/memberViewClassDetail?Id=" + n.classId + "' /><button class='btn' name='" + n.classAvaliable+"' style='float:none' onclick='resvConfirm(" + n.classId + ")'>立即預約</button></input></div><div style='justify-content: center;''></p></div></div></div>"

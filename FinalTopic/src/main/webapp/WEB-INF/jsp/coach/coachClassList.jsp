				...
				.ajax({
					...
					success : function(data) {
						...
						if (data == null) {
							...
							table
									.append("<tr id='ptitle'><th>課程名稱</th><th>開課日期</th><th>上課時間</th><th>結束時間</th><th>課程時數</th><th>價格</th><th>教練</th><th>課程狀態</th><th>操作</th></tr>");
...
console.log(n.classId)
								...
								var tr = "<tr align='center'>" + "<td>"
										...
										+ status + "</td>"+"<td><input type='button' value='編輯' onclick=" + "location.href='/coach/updateClass?Id=" + n.classId + "' /></td></tr>";

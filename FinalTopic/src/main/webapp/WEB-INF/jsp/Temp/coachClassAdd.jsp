...
<!-- 				 <fieldset> -->
				...
				<table style="border-collapse:separate; border-spacing:0px 10px;">
					...
					<tr>
						...
						<td><form:input style="background-color:white;width:100%;border:2px black solid;color:black" id="show" type="number" min="1"
								max="2" step="1" onchange="print_value();" path="classDuration" />小時<br>
							<form:errors path="classDuration" />
					</tr>
					<tr>
						<td align='right'>結束時間：</td>
						<td><form:input style="background-color:white;width:100%;border:2px black solid;color:black" id="end"
					...
					<tr>
						...
						<td><form:input style="background-color:white;width:100%;border:2px black solid;color:black" path="classPrice" /><br> <form:errors
								path="classPrice" />
					</tr>
					<tr>
						<td align='right'>課程描述：</td>
						<td><form:textarea style="background-color:white;width:100%;border:2px black solid;color:black" path="classDescription" /><br> <form:errors
					...
					<tr>
						...
						<td><form:input style="background-color:white;width:100%;border:2px black solid;color:black" path="claPhoto" type="file" /><br> <form:errors
								path="claPhoto" />
					</tr>

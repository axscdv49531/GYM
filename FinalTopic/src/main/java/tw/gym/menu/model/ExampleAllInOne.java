...
//	}
	...
	public  String genAioCheckOutOneTime(String name,String no,String day,String totalPrice){//String name,String no,String day,String totalPrice
		initial();
		System.out.println("inpayment");
		AioCheckOutOneTime obj = new AioCheckOutOneTime();
		obj.setMerchantTradeNo(no);//"testCompany10000"
//		System.out.println(no+"no");
		obj.setMerchantTradeDate(day);//"2017/01/01 08:05:23"
//		System.out.println(day+"day");
		obj.setTotalAmount(totalPrice);//"500"
//		System.out.println(totalPrice+"totalPrice");
		obj.setTradeDesc("test Menu Description");
		obj.setItemName(name);
//		System.out.println(name+"name");
		obj.setReturnURL("http://localhost:8080/pay.ControllerReturn");
		System.out.println("setReturnURL");
		obj.setNeedExtraPaidInfo("N");
		System.out.println("setNeedExtraPaidInfo");
		obj.setRedeem("Y");
		System.out.println("setRedeem");
		obj.getPaymentType();
		System.out.println("getPaymentType");
		obj.getChoosePayment();
		System.out.println("getChoosePayment");
		obj.setRedeem("N");
		System.out.println("setRedeem");
		obj.getRedeem();
		System.out.println("getRedeem");
		obj.getEncryptType();
		obj.setClientBackURL("http://localhost:8080/pay.ControllerReturn");
		obj.setOrderResultURL("http://localhost:8080/pay.ControllerReturn1");
		String form = all.aioCheckOut(obj, null);

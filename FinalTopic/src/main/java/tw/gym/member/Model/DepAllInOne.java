...
public class DepAllInOne {
	...
	public static String genAioCheckOutOneTime(Integer id, String date, String value, String name) {
		...
		obj.setReturnURL("http://localhost:8080/dep.ControllerReturn");
		obj.setClientBackURL("http://localhost:8080/dep.ControllerReturn");
		obj.setOrderResultURL("http://localhost:8080/dep.ControllerReturn1");
...
//	 */
//	public DepAllInOne(String log4jPropertiesPath) {
//		super();

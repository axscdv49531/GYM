...
public class DepositEcpayController {
	...
	@GetMapping("/depositeControl/{id}")
	public String depController(@PathVariable("id") Integer id, Model m) {
...
//		Integer intid=Integer.parseInt(id);
	...
	public String depControllerReturn(Model m, @RequestParam("RtnMsg") String mess) {
		System.out.println("mess=" + mess);
		return null;
	}

	@PostMapping("dep.ControllerReturn1")
	public String depControllerReturn1(Model m, @RequestParam("RtnMsg") String mess,
		...
		if (mess.equals("Succeeded")) {
			...
			Integer intid = Integer.valueOf(id.substring(9));

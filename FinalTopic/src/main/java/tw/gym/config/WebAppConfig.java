...
public class WebAppConfig implements WebMvcConfigurer {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addViewController("/login/AdminSuccess").setViewName("admin/adminindex");
...
//		registry.addViewController("/").setViewName("index");
		...
		registry.addViewController("/courseSelectSystem").setViewName("member/courseSelectSytem");
		...
		registry.addViewController("/adminnavbarMenu").setViewName("adminMenu/adminnavbar");
